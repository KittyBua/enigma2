...
SystemInfo["LCDsymbol_circle_recording"] = fileCheck("/proc/stb/lcd/symbol_circle") or model in ("hd51", "vs1500", "bre2ze4k") and fileCheck("/proc/stb/lcd/symbol_recording")
SystemInfo["LCDsymbol_timeshift"] = fileCheck("/proc/stb/lcd/symbol_timeshift")
SystemInfo["LCDshow_symbols"] = (model.startswith("et9") or model in ("hd51", "vs1500", "bre2ze4k")) and fileCheck("/proc/stb/lcd/show_symbols")
...
SystemInfo["MaxPIPSize"] = model in ("hd51", "h7", "vs1500", "e4hd", "bre2ze4k") and (360, 288) or (540, 432)
...
if model in ("et7500", "et8500", "bre2ze4k"):
